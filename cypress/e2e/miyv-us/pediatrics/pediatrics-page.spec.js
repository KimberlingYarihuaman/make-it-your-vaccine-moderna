...
import { pediatrics } from "../../../components/miyv/miyv-us/pediatrics/pediatrics-page-component";


describe('MIYV-AU: Pediatrics Page', () => {
    ...
    it('User Is Able To Validate The Links Status Of Assembly Accordion Section', () => {
        //ACCORDION ITEMS
        commons.getAccordionListItems().should('be.visible').each(($AccordionList, item) => {

          cy.wrap($AccordionList).within(() => {

            //THESE ITEMS DO NOT HAVE ANY LINKS
            if(item!=5 && item!=6 && item!=7 && item!=8) {
            
                pediatrics.getAccordionSectionLinks().each(($link) => {
    ...
    it('User Is Able To Click On The Link Of Understanding Safety Section The And See The Leaving Modal', () => {
       
        pediatrics.getFirstLayoutColumnsSectionLinks().each(($el) => {
            //VALIDATE THE LINK STATUS
    ...
    it('User Is Able To Click On Get Booster Info Button', () => {
